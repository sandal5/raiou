...
const DEFAULT_LANG = import.meta.env.STORYBLOK_DEFAULT_LANG || 'ja'
...
const LANGUAGE_FLAGS = {
  ...
  ja: `<g clip-path="url(#a)"><rect width="22" height="16" x="-3" fill="#fff" rx="2"/><path fill="#BC002D" d="M-3 5.333h22v5.334h-22z"/></g><defs><clipPath id="a"><rect width="22" height="16" x="-3" fill="#fff" rx="2"/></clipPath></defs>`
}
...
const getLanguages = async () => {
  try {
    ...
    console.warn('Failed to fetch Storyblok languages, using default languages')
