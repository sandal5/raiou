(function(v,_){typeof exports=="object"&&typeof module<"u"?_(exports):typeof define=="function"&&define.amd?define(["exports"],_):(v=typeof globalThis<"u"?globalThis:v||self,_(v.storyblokAstro={}))})(this,function(v){"use strict";const _=`
...
`;function le(e,t,r){const s="virtual:storyblok-init",o=`\0${s}`;return{name:"vite-plugin-storyblok-init",async resolveId(n){if(n===s)return o},async load(n){if(n===o)return`
...
`)}
    ...
    ${r.map(n=>{var l;const i=(l=n.match(/import\s+(\w+)\s+from/))==null?void 0:l[1];return`storyblokComponents['${i}'] = ${i};`}).join(`
`)}
